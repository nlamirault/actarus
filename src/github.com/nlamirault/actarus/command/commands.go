...
type Command struct {
	Name        string
	Action      func(string) (*Output, error)
	Arg         string
	Description string
}
...
func actionAbout(args string) (*Output, error) {
	return &Output{
		Content: fmt.Sprintf("Version :%s", version.Version),
	}, nil
}

func actionHelp(args string) (*Output, error) {
	return nil, nil
}

func actionQuit(args string) (*Output, error) {
